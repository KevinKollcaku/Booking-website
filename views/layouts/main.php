...
<head>
    ...
    <style>
        ...
        nav {
            background: linear-gradient(90deg, #05566a 0%, #29bdcb 60%, #70dbf6 100%);
        }
        .nav-link {
            color: white;
            font-weight: bold;
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">BH</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/hotels">Hotles</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/hotelsregister">Register Hotel</a>
                </li>
